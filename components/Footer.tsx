      ...
      <div className="wrap">
        <div className="ftr-grid">
          <div>
            ...
            <p className="mono" style={{ color: 'var(--pearl)', marginBottom: '8px' }}>Saleroom bulletin</p>
            <p style={{ color: 'var(--dim-lt)', fontSize: '.9rem', marginBottom: '16px', maxWidth: '28ch' }}>
          ...
          <div>
            ...
            <ul>
              ...
              <li><Link href="/sale">September catalogue</Link></li>
              <li><Link href="/bidding">How to bid</Link></li>
          ...
          <div>
            ...
            <ul>
              ...
              <li><Link href="/sell">Free valuations</Link></li>
              <li><Link href="/art">Art department</Link></li>
              <li><Link href="/jewels">Jewels department</Link></li>
            </ul>
          </div>
          <div>
